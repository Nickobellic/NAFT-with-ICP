...
const AuctionRender = ({data, ownerList, idList, buyFunction, type}) => {
    return (<div>
    ...
    {data.length == 0 && 
        (<h2 style={{color: "white", marginTop: "75px", textAlign: "center"}}>No {type}s present in Auction</h2>)}
    </div>)
    
}

export default AuctionRender;